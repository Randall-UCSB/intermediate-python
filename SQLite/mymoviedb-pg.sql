...
-- Clean up existing tables and make them from scratch.
drop table if exists directors, genres, actors, movies, genrelist;
...
-- This not necessary if we drop the tables and recreate every time.
...
-- We are not going to auto increment directors
...
-- Use numeric for date since we don't have day and month.  
-- Escape single quote:  E'You\'ve Got Mail'
...
(4,E'You\'ve Got Mail',1988,65000000,250800000,5),
...
(17,E'Who\'s Afraid of Virginia Woolf?',1966,7500000,40000000,9),
...
--insert into moviecast (id, movie_id, actor_id) VALUES (1,1,1);
